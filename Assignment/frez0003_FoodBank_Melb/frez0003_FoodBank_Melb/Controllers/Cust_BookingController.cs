...
namespace frez0003_FoodBank_Melb.Controllers
{
    public class Cust_BookingController : Controller
    {
        ...
        {
            var cust_Booking = db.Cust_Booking.Include(c => c.Reg_Customer).Include(c => c.Restaurant);
        ...
        {
            ViewBag.Customer_id = new SelectList(db.Reg_Customer, "Id", "C_Email");
        ...
        public ActionResult Create([Bind(Include = "Id,Resturent_id,Customer_id,Booking_Date_time")] Cust_Booking cust_Booking)
        {
            ...
            ViewBag.Customer_id = new SelectList(db.Reg_Customer, "Id", "C_Email", cust_Booking.Customer_id);
