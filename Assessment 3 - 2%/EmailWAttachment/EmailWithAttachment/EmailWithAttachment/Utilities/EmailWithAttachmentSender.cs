...
namespace EmailWithAttachment.Utilities
{
    public class EmailWithAttachmentSender
    {
        ...
        public void Sender(EmailWithAttachmentViewModel model, string pathFull)
        {
            ...
            var from = new EmailAddress("noreply@localhost.com", "Lab Assessment 3 Email With Attachment");
